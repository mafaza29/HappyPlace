...
class DatabaseHandler(context: Context):
    ...
    companion object{
        private const val DATABASE_VERSION = 1 // versi database
        private const val DATABASE_NAME = "HappyPlaceDatabase"// nama database
    ...
    fun addHappyPlace(happyPlace: HappyPlacesModel): Long{
        ...
        contentValues.put(KEY_TITLE, happyPlace.title) // HappyPlaceModelClassTitle
        contentValues.put(KEY_IMAGE, happyPlace.image) // HappyPlaceModelClassImage
